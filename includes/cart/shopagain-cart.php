...
function sha_load_started_checkout() {
    ...
    if ( is_checkout() ) {
        ...
        wp_localize_script( 'sha_initiated_checkout', 'shopagain_public_key', array( 'token' => $token, "callback_url" => Shopagain::get_shopagain_option( 'shopagain_webhook_url' )));
        wp_localize_script( 'sha_initiated_checkout', 'shopagain_localstorage_key', $shopagain_localstorage_key);
    }
}
