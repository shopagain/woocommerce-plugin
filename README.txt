...
1. Download the plugin shopagain.1.0.1.zip
2. Go to WordPress Dashboard-Plugins-Add New
3. Click on Upload Plugin link from top
4. Upload the downloaded shopagain.1.0.1.zip file and click on Install Now
...
= 1.0.1 =
Included a customized ShopAgain JS for popups in public pages except for the checkout page.
The popups help to maximize email and SMS list growth and drive revenue. 
